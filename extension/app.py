...
def app(code):
    ...
    nbf.write(nb, '../userInputNotebook.ipynb')
...
Install required packages before running"""))
    ...
    nbf.write(nb, '../ImageClassification_PyTorch.ipynb')
...
Install required packages before running"""))
    ...
    nbf.write(nb, '../ImageClassification_Scikit.ipynb')
...
Install required packages before running"""))
    ...
    nbf.write(nb, '../ModelSelection_scikit.ipynb')
...
Install required packages before running"""))
    ...
    nbf.write(nb, '../MulticlassClassification.ipynb')
